...
const Button = React.forwardRef(
  (
    ...
    const variants = {
      default:
        "bg-blue-800 text-white hover:bg-blue-600/90 dark:bg-blue-50 dark:text-blue-900 dark:hover:bg-blue-50/90",
      outline:
        "border border-blue-200 bg-white hover:bg-blue-100 hover:text-blue-900 dark:border-blue-800 dark:bg-blue-950 dark:hover:bg-blue-800 dark:hover:text-blue-500",
      secondary:
        "bg-blue-800 text-blue-900 hover:bg-blue-100/80 dark:bg-blue-800 dark:text-blue-50 dark:hover:bg-blue-800/80",
      ghost:
